...
<div class="user">
    <ul class="ul_user">
        ...
        <li><a href="./?p=cart"><i class="fas fa-shopping-cart"></i><span class="badge badge-light"><?php if(isset($_SESSION["cart"])){echo count($_SESSION["cart"]);}else{echo "0";} ?></span></a></li>
