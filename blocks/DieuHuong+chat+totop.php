...
<!-- End thanh người dùng -->

<!-- Back to top & chat -->
	<button onclick="topFunction()" style="display: none;" id="myBtn" title="Go to top">
	...
	<!-- Load Facebook SDK for JavaScript -->
      ...
      <div class="fb-customerchat"
        ...
        page_id="100365821891587"
	  	theme_color="#0A7CFF"
	  	logged_in_greeting="Tasty Cakes xin chào bạn !"
	  	logged_out_greeting="Tasty Cakes xin chào bạn !">
      </div>
